...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the doubly linked list benchmark executable and store parsed results."
    )
    parser.add_argument(
        "--command",
        default="opam exec -- dune exec ./benchmarking/benchmark_doubly_linked_list.exe",
...
def main() -> int:
    ...
    raw_latest = output_dir / "benchmark_doubly_linked_list_raw_latest.txt"
    raw_timestamped = output_dir / f"benchmark_doubly_linked_list_raw_{timestamp}.txt"
    ...
    csv_latest = output_dir / "benchmark_doubly_linked_list_results_latest.csv"
    csv_timestamped = output_dir / f"benchmark_doubly_linked_list_results_{timestamp}.csv"
    json_latest = output_dir / "benchmark_doubly_linked_list_results_latest.json"
    json_timestamped = output_dir / f"benchmark_doubly_linked_list_results_{timestamp}.json"
    meta_latest = output_dir / "benchmark_doubly_linked_list_metadata_latest.json"
